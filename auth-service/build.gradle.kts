...
dependencies {
    ...
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray-propagator:1.60.0-alpha")
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray:1.60.0")
