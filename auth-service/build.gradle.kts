...
dependencies {
    ...
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray-propagator:1.59.0-alpha")
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray:1.59.0")
