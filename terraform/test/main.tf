...
module "auth_service" {
  ...
  ldap_config = {
    CA_S3_URL                   = "https://data-collection-service-ldaps-crl-test.s3.amazonaws.com/CASRVTEST8/CASRVtest8.dluhctest.local_CASRVtest8.crt"
    ...
    USER_CONTAINER_DN           = "CN=Datamart,OU=Users,OU=dluhctest,DC=dluhctest,DC=local"
  }
