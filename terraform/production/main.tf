...
locals {
  ...
  dclg_access_group_notification_settings = {
    enabled                     = true
    additional_recipient_emails = ["Group-DLUHCDeltaNotifications@softwire.com", "delta-notifications@communities.gov.uk", "DELTAadmin@levellingup.gov.uk", "DELTAStatSupport@levellingup.gov.uk"]
  }
}
